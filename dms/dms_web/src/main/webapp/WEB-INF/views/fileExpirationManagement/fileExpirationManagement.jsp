...
<head>
   ...
   <%@include file="/WEB-INF/views/common/common.jsp"%>
    <script src="static/js/fileExpirationManagement/fileExpirationManagement.js"></script>
</head>
<body>
<%--datagrid--%>
<table id="fileExpirationManagementDatagrid"></table>
<%--toolbar--%>
<div id="toolbar">
...
<%--添加或者编辑的dialog--%>
<div id="fileExpirationManagementDlg" class="easyui-dialog" style="width: 400px"
     closed="true" buttons="#dlg-buttons">
    <form id="fileExpirationManagementForm" method="post" novalidate style="margin:0;padding:20px 50px">
        <%--编辑隐藏域的处理--%>
        ...
        <table>
            ...
            <tr>
                <td>
                    销毁日期:<input class="easyui-DateTimeBox" name="destorydate">
                </td>
            </tr>
            <tr>
                <td>
                    销毁原因:<input class="easyui-combobox" name="destory.id"
                              data-options="valueField:'id',textField:'name',panelHeight:'auto',url:'/systemDictionaryDetail/destoryReason'">
                </td>
            </tr>
            <tr>
                <td>
