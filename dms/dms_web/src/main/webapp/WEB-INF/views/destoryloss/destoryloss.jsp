...
<head>
   ...
   <%@include file="/WEB-INF/views/common/common.jsp"%>
    <script src="static/js/destoryloss/destoryloss.js"></script>
</head>
<body>
<%--datagrid--%>
<table id="destorylossDatagrid"></table>
<%--toolbar--%>
<div id="toolbar">
...
<%--添加或者编辑的dialog--%>
<div id="destorylossDlg" class="easyui-dialog" style="width: 400px"
     closed="true" buttons="#dlg-buttons">
    <form id="destorylossForm" method="post" novalidate style="margin:0;padding:20px 50px">
        <%--编辑隐藏域的处理--%>
        ...
        <table>
            ...
            <tr>
                <td>
                    类型:<input class="easyui-combobox" name="destory.id"
            ...
            <tr>
                <td>
                    事故日期:<input class="easyui-DateTimeBox" name="appenddate">
                </td>
            </tr>
            <tr>
                <td>
