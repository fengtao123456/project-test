...
<head>
   ...
   <%@include file="/WEB-INF/views/common/common.jsp"%>
    <script src="static/js/sysresource/sysresource.js"></script>
</head>
<body>
<%--datagrid--%>
<table id="sysresourceDatagrid"></table>
<%--toolbar--%>
<div id="toolbar" style="padding:5px;height:auto">
    ...
    <%--高级查询--%>
        <form id="searchForm" action="/employee/download" method="post">
            <%--textbox：文本框--%>
            资源名称： <input name="name" class="easyui-textbox" style="width:80px;height:32px">
            资源路径: <input name="url" class="easyui-textbox" style="width:80px;height:32px">
                <a href="javaScript:;" data-cmd="search"  class="easyui-linkbutton" iconCls="icon-search">查找</a>
        </form>
    </div>
</div>
<%--添加或者编辑的dialog--%>
<div id="sysresourceDlg" class="easyui-dialog" style="width: 400px"
     closed="true" buttons="#dlg-buttons">
    <form id="sysresourceForm" method="post" novalidate style="margin:0;padding:20px 50px">
        <%--编辑隐藏域的处理--%>
        ...
        <table>
            ...
            <tr>
                <td>
                    资源使用状态:<input type="text" name="status">
                </td>
            </tr>
        </table>
    </form>
