...
<head>
   ...
   <%@include file="/WEB-INF/views/common/common.jsp"%>
    <script src="static/js/systemDictionaryType/systemDictionaryType.js"></script>
</head>
<body>
<%--datagrid--%>
...
<%--添加或者编辑的dialog--%>
<div id="systemDictionaryTypeDlg" class="easyui-dialog" style="width: 400px"
     closed="true" buttons="#dlg-buttons">
    <form id="systemDictionaryTypeForm" method="post" novalidate style="margin:0;padding:20px 50px">
        <%--编辑隐藏域的处理--%>
        ...
        <table>
            ...
            <tr>
                <td>
                    是否启用:<input type="text" name="status">
                </td>
            </tr>
        </table>
    </form>
