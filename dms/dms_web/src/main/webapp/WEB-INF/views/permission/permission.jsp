...
<div id="toolbar" style="padding:5px;height:auto">
    <div>
        ...
        <form id="searchForm" action="/employee/download" method="post">
            <%--textbox：文本框--%>
            权限名称: <input name="name" class="easyui-textbox" style="width:80px;height:32px">
             <%--<input name="status" class="easyui-textbox" style="width:80px;height:32px">--%>
                权限状态：<select id="cc" class="easyui-combobox" name="status" style="width:80px;height:32px">
...
<div id="permissionDlg" class="easyui-dialog" style="width: 400px"
    ...
    <form id="permissionForm" method="post" novalidate style="margin:0;padding:20px 50px">
        ...
        <table>
            ...
            <tr>
                <td>
                    资源路径:<input type="text" name="sysresource">
                </td>
            </tr>
            <tr>
                <td>
