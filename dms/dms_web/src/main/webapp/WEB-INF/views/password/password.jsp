...
<body>
<%--datagrid--%>
<table id="passwordDatagrid"></table>
<%--toolbar--%>
<div id="toolbar">
...
<%--添加或者编辑的dialog--%>
<div id="passwordDlg" class="easyui-dialog" style="width: 400px"
     closed="true" buttons="#dlg-buttons">
    <form id="passwordForm" method="post" novalidate style="margin:0;padding:20px 50px">
        <%--编辑隐藏域的处理--%>
